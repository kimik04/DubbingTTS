...
| macOS (Intel) | faster-whisper | CTranslate2, lightweight |
| Windows | faster-whisper | No PyTorch needed, ~4x faster than openai-whisper |
| Linux | faster-whisper | CPU int8 by default, CUDA optional |
